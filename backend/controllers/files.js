...
exports.uploadFile = async (req, res) => {
  ...
  try {
    ...
    const job = await fileQueue.add('processFile', { fileId, filePath, mimetype }, { attempts: 3 });
    await pool.query('INSERT INTO jobs (id, file_id, status) VALUES ($1, $2, $3)', [job.id, fileId, 'pending']);
